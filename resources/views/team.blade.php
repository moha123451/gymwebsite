        ...
        <div class="row">
            @foreach($teamMembers as $member)
                <div class="col-lg-4 col-sm-6">
                    <div class="ts-item set-bg" data-setbg="{{ asset('img/team/' . $member['image']) }}">
                        <div class="ts_text">
                            <h4>{{ $member['name'] }}</h4>
                            <span>{{ $member['role'] }}</span>
                            <div class="tt_social">
                                <a href="{{ $member['social_links']['facebook'] }}"><i class="fa fa-facebook"></i></a>
                                <a href="{{ $member['social_links']['twitter'] }}"><i class="fa fa-twitter"></i></a>
                                <a href="{{ $member['social_links']['youtube'] }}"><i class="fa fa-youtube-play"></i></a>
                                <a href="{{ $member['social_links']['instagram'] }}"><i class="fa fa-instagram"></i></a>
                                <a href="{{ $member['social_links']['email'] }}"><i class="fa fa-envelope-o"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
